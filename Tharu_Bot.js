  ...
  try {
    ...
    const fkontak = {
      key: {
        ...
        ...(from ? { remoteJid: `94789864930 -1614953337@g.us` } : {}),
      },
      message: {
        contactMessage: {
    ...
    const fvideo = {
      key: {
        fromMe: false,
        participant: `0@s.whatsapp.net`,
        ...(from ? { remoteJid: "94789864930-1613049930@g.us" } : {}),
      },
      message: {
        videoMessage: {
          title: `${global.botname}`,
    ...
    const fgclink = {
      ...
      message: {
        groupInviteMessage: {
          groupJid: "94789864930-1616169743@g.us",
        ...
        m.chat,
        {
          ...
          contextInfo: {
            externalAdReply: {
              ...
              previewType: "PHOTO",
              thumbnailUrl: ``,
              thumbnail: fs.readFileSync(`./Media/theme/Tharu Bot 1.jpg`),
              sourceUrl: `${linkz}`,
            },
          },
        },
      ...
      case "ban":
        {
          ...
          if (!args[0])
            return replay(
              `Select add or del(add to ban, del to unban), For Example: Reply *${prefix}ban add* to the user u want to ban`
            );
          if (args[1]) {
      ...
      case "buy":
        {
          ...
          if (args[0] === "potion") {
            ...
            if (!args[1])
              return reply(
                `Example : ${prefix + command} limit 2\n 1 Limit = 35000 Money`
              );
            if (isMonay < noh)
              return reply(
                "Your Remaining Money Is Not Sufficient For This Purchase"
      ...
      case "jual":
        {
          ...
          if (args[0] === "fish") {
            ...
            if (!args[1])
              return reply(
                `Example : ${prefix + command} rabbit 2\n 1 Rabbit = 3000 Money`
              );
            ...
            if (!args[1])
              return reply(
                `Example : ${prefix + command} domba 2\n 1 Sheep = 5000 money`
              );
...
Please @${m.mentionedJid[0].split`@`[0]} To Type Accept/Reject`;
      ...
      case "holoh":
        ...
        if (isBanChat) return reply(mess.banChat);
        if (!m.quoted && !text)
          return replay(`Send/Reply Text With Caption ${prefix + command}`);
...
Cieeee, What's Going On❤️💖👀`;
      ...
      case "can":
        ...
        if (!text)
          return replay(
            `Use Text, Example : ${prefix + command} you fuck her lol `
          );
      ...
      case "how":
        ...
        if (isBanChat) return reply(mess.banChat);
        if (!text)
          return replay(`Use Text, Example : ${prefix + command} is my face`);
        const gimana = [
          `It's Okay`,
          `It's Difficult Bro`,
      ...
      case "rate":
        ...
        if (isBanChat) return reply(mess.banChat);
        if (!text)
          return replay(`Use Text, Example : ${prefix + command} My Dp`);
        const ra = [
          "1",
          "2",
          "3",
      ...
      case "handsomecheck":
        ...
        if (isBanChat) return reply(mess.banChat);
        if (!text)
          return replay(`Tag Someone, Example : ${prefix + command} @Xeon`);
        const gan = [
          "1",
          "2",
          "3",
      ...
      case "when":
        ...
        if (!text)
          return replay(
            `Use Text, Example : ${prefix + command} will i get married `
          );
        const kapan = [
          "5 More Days",
          "10 More Days",
      ...
      case "wangy":
        ...
        if (isBanChat) return reply(mess.banChat);
        if (!text)
          return replay(`Use Text, Example : ${prefix + command} hinata`);
        qq = q.toUpperCase();
      ...
      case "checkdeath":
        ...
        if (!text)
          return replay(
            `Use Someone's Name, Example : ${prefix + command} Bot`
          );
      ...
      case "setexif":
        {
          ...
          if (!isCreator) return replay(`${mess.owner}`);
          if (!text)
            return replay(`Example : ${prefix + command} packname|author`);
...
`;
      ...
      case "bcgroup":
        {
          ...
          replay(
            `Send broadcast to ${anu.length} group chat, time's up ${
              anu.length * 1.5
            } second`
          );
          for (let i of anu) {
      ...
      case "bcaudio":
        {
          ...
          if (!/video/.test(mime) && !/image/.test(mime) && !/audio/.test(mime))
            return reply(
              `*Send/Reply Video/Audio/Image You Want to Broadcast With Caption* ${
                prefix + command
              }`
            );
          let anu = await store.chats.all().map((v) => v.id);
          let ftroli = {
            key: {
              fromMe: false,
              participant: "0@s.whatsapp.net",
              remoteJid: "94789864930-1604595598@g.us",
            },
            message: {
              orderMessage: {
                itemCount: 999999999,
          ...
          reply(
            `*Send Broadcast To* ${anu.length} *Group Chat, Time ${
              anu.length * 1.5
            } secs*`
          );
          for (let i of anu) {
      ...
      case "scdl":
        {
          ...
          if (!isUrl(args[0]) && !args[0].includes("soundcloud.com"))
            return reply(`*Not a soundcloud link*`);
          xeonkey
            .SoundCloud(`${text}`)
            .then(async (data) => {
      ...
      case "ebinary":
        {
          ...
          if (!m.quoted.text && !text)
            return replay(`Reply Text With Caption ${prefix + command}`);
      ...
      case "zippyshare":
        {
          ...
          if (!isUrl(args[0]) && !args[0].includes("zippyshare.com"))
            return reply(`The link is not a zippyshare link`);
          anu = await fetchJson(
      ...
      case "savefrom":
        {
          ...
          if (!text)
            return m.reply(
              `Failed to download media and send audio ${
                prefix + command
              } url link`
            );
      ...
      case "readmore":
        {
          ...
          anu = await fetchJson(
            `https://cililitan.herokuapp.com/api/readmore?teks=${text}`
          );
          reply(`${anu.result}`);
        }
        break;
      ...
      case "demon":
        {
          if (!q)
            return reply(`Example : ${prefix + command} ${global.ownername}`);
          if (isBan) return reply(mess.ban);
          if (isBanChat) return reply(mess.banChat);
          reply(mess.wait);
          let link;
      ...
      case "ytsearch":
        {
          ...
          if (isBanChat) return reply(mess.banChat);
          if (!args.join(" "))
            return replay(`Example : ${prefix + command} stay jb`);
      ...
      case "instagramstory2":
        {
          ...
          hx.igstory(urlnya)
            ...
            .catch((err) =>
              reply(
                `Sorry username ${text} was not found or maybe he/she has no story uploaded in her id`
              )
            );
        }
        break;
      ...
      case "instagram2":
        {
          ...
          if (!isUrl(args[0]) && !args[0].includes("instagram.com"))
            return reply(`The link you provided is not a instagram link`);
          let urlnya = text;
          hx.igdl(urlnya)
            .then(async (result) => {
              var halo = 0;
      ...
      case "donlod":
        {
          ...
          if (isBanChat) return reply(mess.banChat);
          if (!text) return reply(`Use${prefix + command} whatsapp`);
          if (!isUrl(args[0]) && !args[0].includes("rexdl.com"))
            reply("*The link you provided is invalid*");
          let rex = require("./lib/ApkDown.js");
          rex
            .ApkDown(`${text}`)
            .then(async (anu) => {
              if (anu[0].size.split("MB")[0] >= 150)
      ...
      case "drakor":
        {
          ...
          if (!text) return reply(`Example : ${prefix + command} love`);
          let res = await fetchJson(
            `https://zenzapis.xyz/webzone/drakor?query=${text}&apikey=hdiiofficial`
          );
      ...
      case "mcpedl":
        {
          ...
          if (isBanChat) return reply(mess.banChat);
          if (!args.join(" "))
            return replay(`Example : ${prefix + command} shader`);
      ...
      case "happymod":
        {
          ...
          if (isBanChat) return reply(mess.banChat);
          if (!args.join(" "))
            return replay(`Example : ${prefix + command} mobile legend`);
      ...
      case "cinemaschedule":
        {
          ...
          let res = await fetchJson(
            `https://zenzapis.xyz/webzone/jadwalbioskop?kota=${text}&apikey=hdiiofficial`
          );
      ...
      case "cocoknama":
        {
          ...
          if (isBanChat) return reply(mess.banChat);
          if (!text)
            return reply(`Example : ${prefix + command} Dika, 7, 7, 2005`);
      ...
      case "fengshui":
        {
          ...
          if (!text)
            return reply(
              `Example : ${prefix + command} Dika, 1, 2005\n\nNote : ${
                prefix + command
      ...
      case "peruntungan":
        {
          ...
          if (!text)
            return reply(
              `Example : ${prefix + command} DIka, 7, 7, 2005, 2022\n\nNote : ${
                prefix + command
      ...
      case "masasubur":
        {
          ...
          if (isBanChat) return reply(mess.banChat);
          if (!text)
            return `Example : ${prefix + command} 12, 1, 2022, 28\n\nNote : ${
              prefix + command
            ...
            hx.pinterest(args.join(" "))
              .then(async (res) => {
                ...
                let buttonMessage = {
                  image: { url: imgnyee },
                  caption:
                    `${global.dogeemoji} Title : ` +
                    args.join(" ") +
                    `\n${global.dogeemoji} Media Url : ` +
                    imgnyee,
                  footer: `${global.botname}`,
                  buttons: buttons,
                  headerType: 4,
      ...
      case "ringtone":
        {
          ...
          if (!text)
            return reply(
              `Where is the ringtone name noob?, Example : ${
                prefix + command
              } charlie puth`
            );
      ...
      case "antitag":
        {
          ...
          if (!isCreator) return;
          if (args.length < 1)
            return replay(`Type on to enable\nType off to disable`);
          if (args[0] === "on") {
                    ...
                    rows: [
                      {
                        title: "💙 Other 💙",
                        description:
                          "💞 Displays The List Of Other Features 💞",
                    ...
                    rows: [
                      {
                        title: "💙 All Menu 💙",
                        description:
                          "💞 Displays The List Of All The Features 💞",
                        rowId: `${prefix}allmenu`,
                      },
                      {
                        title: "💙 Owner Menu 💙",
                        description:
                          "💞 Displays The List Of Owner Features 💞",
                      ...
                      },
                      {
                        title: "💙 Maker Menu 💙",
                        description:
                          "💞 Displays The List Of Logo Making Features 💞",
                        rowId: `${prefix}indomenu`,
                      },
                      {
                        title: "💙 Sound Menu 💙",
                        description:
                          "💞 Displays The List Of Sound Features 💞",
                        rowId: `${prefix}soundmenu`,
                      },
                      {
                        title: "💙 Download Menu 💙",
                        description:
                          "💞 Displays The List Of Download Features 💞",
                        rowId: `${prefix}downloadmenu`,
                      },
                      {
                        title: "💙 Sticker Menu 💙",
                        description:
                          "💞 Displays The List Of Sticker Features 💞",
                        rowId: `${prefix}indomenu`,
                      },
                      {
                        title: "💙 Search Menu 💙",
                        description:
                          "💞 Displays The List Of Searching Features 💞",
                      ...
                      },
                      {
                        ...
                        description:
                          "💞 Displays The List Of Random Image Features 💞",
                        rowId: `${prefix}randomimagemenu`,
                      },
                      {
                        title: "💙 Image Effect Menu 💙",
                        description:
                          "💞 Displays The List Of Image Effect Features 💞",
                      ...
                      },
                      {
                        title: "💙 Emote Menu 💙",
                        description:
                          "💞 Displays The List Of Emote Features 💞",
                        rowId: `${prefix}emotemenu`,
                      },
                      {
                        title: "💙 Anime Sticker Menu 💙",
                        description:
                          "💞 Displays The List Of Anime Sticker Features 💞",
                      ...
                      },
                      {
                        title: "💙 Convert Menu 💙",
                        description:
                          "💞 Displays The List Of Convert Features 💞",
                        rowId: `${prefix}convertmenu`,
                      },
                      {
                        title: "💙 Database Menu 💙",
                        description:
                          "💞 Displays The List Of Database Features 💞",
                    ...
                    rows: [
                      {
                        title: "💙 Thanks To 💙",
                        description:
                          "💞 Displays The List Of Credit Of Tharu Bot 💞",
                        rowId: `${prefix}tqtt`,
                      },
                    ],
                  },
...
╚═════════════✪` +
          ...
          [
            ...
            { urlButton: { displayText: "Rivishan 💙", url: `${botscript}` } },
            {
              quickReplyButton: { displayText: "Contact Me 💙", id: "donate" },
            },
            { quickReplyButton: { displayText: "Owner 😎", id: "owner" } },
          ]
        );
